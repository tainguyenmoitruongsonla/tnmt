...
const columnsTable = [
  ...
  {
    id: '#',
    label: 'Chiều sâu đoạn thu nước(m)',
    children: [
  ...
  {
    id: '#',
    label: 'Thông số của công trình khai thác',
    showId: [1, 4, 5, 6, 11],
    children: [
      {
        id: 'WaterSupplyFlow',
  ...
  return (
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} sm={5} md={3}>
        <Typography className='_font12'>Tổng số công trình KTSDN mặt: 100</Typography>
        <Typography className='_font12'>Số công trình đã cấp phép: 71</Typography>
      </Grid>
      <Grid container xs={12} sm={7} md={9} direction='row' justifyContent='flex-end' alignItems='center' spacing={4}>
