...
const DischargeConstruction = () => {
    ...
    const columnsTable: GridColDef[] = [
        ...
        {
            field: 'tenCT', headerAlign: 'center', headerName: 'Tên công trình', minWidth: 350,
            renderCell: (data) => (
        ...
        //constructionDetails
        { field: 'phuongThucXT', headerAlign: 'center', headerName: 'Phương thức xả nước thải', minWidth: 150, },
    ...
    useEffect(() => {
        const filteredData = resData.filter((item: { [key: string]: any }) =>
            initConsType.some((keyword: any) =>
                item['loaiCT']?.['maLoaiCT']?.toLowerCase().includes(keyword.toLowerCase())
            )
        );
