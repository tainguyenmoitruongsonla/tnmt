...
import ConstructionLocation from './ConstructionLocation'

const complete1 = [
  { title: "Thủy điện", value: 1 },
  { title: "Hồ chứa", value: 2 },
  { title: "Trạm bơm", value: 3 },
  { title: "Công trình khác", value: 6 },
];
const FormContruction = ({ onSubmit, closeDialogs }: any) => {
  ...
  const handleChange = (e: any) => {
    const val = (e == undefined || e == null ? 6 : e.value)
    setTypeOfConsId(val)
