        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6} sm={12} sx={{ my: 2 }}>
            <TextField
              ...
              label='Năm vận hành'
              placeholder=''
              defaultValue={consData.namBatDauVanHanh}
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6} sm={12} sx={{ my: 2 }}>
            <TextField
              ...
              fullWidth
              placeholder=''
              defaultValue={consData.thoiGianHNK}
              multiline
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={12} sm={12} sx={{ my: 2 }}>
            <TextField
              ...
              fullWidth
              placeholder=''
              defaultValue={consData.mucDichhTD}
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} md={4} sm={12} sx={{ my: 2 }}>
                <TextField
                  ...
                  fullWidth
                  placeholder=''
                  defaultValue={consData.soLuongGieng}
          ...
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} md={4} sm={12} sx={{ my: 2 }}>
              <TextField
                ...
                fullWidth
                placeholder=''
                defaultValue={consData.thoiGianXD}
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={6} sm={12} sx={{ my: 2 }}>
              <TextField
                ...
                fullWidth
                placeholder=''
                defaultValue={consData.quyMoHNK}
            ...
            <Grid item xs={12} md={6} sm={12} sx={{ my: 2 }}>
              <TextField
                ...
                fullWidth
                placeholder=''
                defaultValue={consData.khoiLuongCacHangMucTD}
