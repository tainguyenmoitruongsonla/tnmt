...
import CreateReport20 from './CreateReport20'

const Report20Table = ({ data, handlePostSuccess }: any) => {
  return (
            ...
            {data.map((item: any, index: any) => (
              <TableRow key={item.id}>
                ...
                <TableCell align='center' className="  size='small' align-middle font-13">
                  <Box>
                    <CreateReport20 isEdit={true} data={item} setPostSuccess={handlePostSuccess} />
